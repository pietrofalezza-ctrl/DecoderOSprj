...
import { KNOWLEDGE_CATEGORIES, KNOWLEDGE_ENTRIES, getLocale } from "@/knowledge/registry";
...
const TYPES: ("all" | KnowledgeType)[] = ["all", "capability", "concept", "integration", "format"];
    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        <header className="mb-8">
          <p className="text-sm font-medium uppercase tracking-wide text-primary">Knowledge Hub</p>
        ...
        <nav aria-label="Browse by type" className="mb-6 flex flex-wrap gap-2">
          <Link
            to="/knowledge/capabilities"
            className="rounded-full border border-border bg-card px-3 py-1.5 text-sm font-medium hover:border-primary/50"
          >
            Capabilities
          </Link>
          <Link
          ...
          <Link
            to="/knowledge/integrations"
            className="rounded-full border border-border bg-card px-3 py-1.5 text-sm font-medium hover:border-primary/50"
          >
            Integrations
          </Link>
          <Link
            to="/knowledge/formats"
            className="rounded-full border border-border bg-card px-3 py-1.5 text-sm font-medium hover:border-primary/50"
          >
            Formats
          </Link>
