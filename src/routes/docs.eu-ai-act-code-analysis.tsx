  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: DESC },
      {
        name: "keywords",
        content:
          "eu ai act, ai act code review, gpai compliance, ai code analysis europe, ai act developer obligations",
      },
    ...
    links: [
      ...
      { rel: "alternate", hrefLang: "en", href: URL },
      {
        rel: "alternate",
        hrefLang: "it",
        href: "https://decoderead.dev/docs/it/eu-ai-act-analisi-codice",
      },
      {
        rel: "alternate",
        hrefLang: "zh",
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 md:py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          The EU AI Act entered into force in August 2024 and phases in through 2026–2027. If you
          ship code in Europe and you use AI to read, review or generate it, this is the practical
          version of what changes for your team and how a <strong>privacy-first, BYOK</strong> tool
          like Decoder fits the new regime.
        </p>

        <Section
          icon={<Scale className="h-5 w-5" />}
          title="Where AI code analysis sits in the risk pyramid"
        >
          <p>
            The Act uses four tiers: <strong>unacceptable</strong>, <strong>high-risk</strong>,{" "}
            <strong>limited-risk</strong>, <strong>minimal-risk</strong>. AI code review is not
            listed in Annex III, so it sits in the limited-risk band by default. The obligation is
            mainly <em>transparency</em>: tell users when output is AI-generated, document the model
            you're using, and keep a human reviewer in the loop for anything that ships to
            production.
          </p>
          <p>
            It escalates to high-risk only when the AI's output materially decides outcomes in
            regulated areas — critical infrastructure, employment, credit scoring, essential public
            services. Reviewing a pull request rarely qualifies; auto-merging it into a payments
            gateway might.
          </p>
        </Section>
        ...
        <Section
          ...
          title="GPAI: what changes for foundation-model users"
        >
          <p>
            The general-purpose AI (GPAI) chapter, applicable from August 2025, puts the bulk of
            obligations on the <strong>provider</strong> of the model: model cards, a training-data
            summary, an EU copyright policy, and (for systemic-risk models above 10^25 FLOPs)
            red-teaming and incident reporting.
          </p>
          <p>
            As a <strong>downstream deployer</strong> you inherit lighter but real duties:
          </p>
          <ul>
            <li>Inform reviewers and affected developers when AI is in the loop.</li>
            <li>
              Keep technical documentation of how you use the model (prompts, retention, who can
              read outputs).
            </li>
            <li>Maintain a human-in-the-loop process for decisions that affect people.</li>
            <li>
              Respect copyright reservations on training data — relevant if you fine-tune on
              internal code.
            </li>
          </ul>
        </Section>
        ...
        <Section
          ...
          title="Why BYOK and local inference simplify compliance"
        >
          <p>
            BYOK means the model provider relationship lives under <strong>your</strong> DPA, not
            the review tool's. The tool becomes a thin client; your auditors only have to assess one
            new sub-processor (the review tool itself, not the LLM provider you already cleared).
          </p>
          <p>
            Local inference (Ollama, LM Studio) collapses the picture further: no provider, no
            transfer, no DPA. For finance, health and defence teams in the EU this is often the only
            path that gets through procurement.
          </p>
        </Section>

        <Section
          icon={<ClipboardCheck className="h-5 w-5" />}
          title="Compliance checklist for engineering teams"
        >
          <ul>
            ...
            <li>
              Train developers on prompt injection and on what counts as personal data in code.
            </li>
          </ul>
        </Section>
          ...
          <ul>
            ...
            <li>
              <Link to="/docs/privacy-first-ai-europe" className="text-foreground underline">
                Privacy-first AI in Europe — 2026 buyer's guide
              </Link>
            </li>
            <li>
              <Link
