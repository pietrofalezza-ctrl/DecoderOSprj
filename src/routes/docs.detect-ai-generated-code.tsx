  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: DESC },
      {
        name: "keywords",
        content:
          "detect ai generated code, ai code detection, ai generated code patterns, llm code review, ai code review tool",
      },
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Docs", item: "https://decoderead.dev/docs" },
            {
              "@type": "ListItem",
              position: 3,
              name: "How to detect AI-generated code",
              item: URL,
            },
          ],
        }),
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 md:py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          ...
          <strong>how to detect AI-generated code</strong> — its structural tells, its typical
          failure modes, and the tooling that flags it automatically — helps reviewers triage faster
          and catch the bugs LLMs reliably miss.
        </p>

        <Section
          icon={<Search className="h-5 w-5" />}
          title="Structural signals of AI-generated code"
        >
          <p>No single trait is conclusive, but a cluster of the following raises confidence:</p>
          <ul>
            <li>
              <strong>Verbosely named variables throughout</strong> — LLMs favour fully descriptive
              names (<code>userAuthenticationToken</code>) where a human would write{" "}
              <code>token</code>.
            </li>
            <li>
        ...
        <Section
          ...
          title="Security patterns common in AI-generated code"
        >
          <p>
          ...
          <ul>
            <li>
              SQL queries assembled with string interpolation, even when an ORM is available nearby.
            </li>
            <li>
              Hardcoded credentials that were present in the training-data snippet the model
              imitated.
            </li>
            <li>
              Missing CSRF, auth, or rate-limit checks on new endpoints — LLMs write the happy path
              first.
            </li>
            <li>
              Dependency imports from packages that do not exist (hallucinated package names).
            </li>
            <li>
              Copies of deprecated cryptographic patterns (MD5 for passwords, ECB block mode).
            </li>
          </ul>
          <p>
        ...
        <Section icon={<Cpu className="h-5 w-5" />} title="Automated detection with Decoder">
          <p>Decoder combines two detection layers that run before any AI call:</p>
          <ol>
            <li>
        ...
        <Section icon={<GitCompare className="h-5 w-5" />} title="Manual review checklist">
          ...
          <ul>
            ...
            <li>
              Look for test coverage: AI code often has 100% happy-path coverage and 0% error-path
              coverage.
            </li>
            <li>
              Search for the function signatures in the model's known training corpus (GitHub, Stack
              Overflow).
            </li>
            <li>
              Ask the author to explain the three least-obvious lines without looking at the file.
            </li>
          </ul>
        </Section>
        ...
        <Section icon={<ShieldCheck className="h-5 w-5" />} title="Policy recommendations">
          ...
          <ul>
            <li>
              Require AI-authored PRs to pass the same automated static + malware scan as any other
              change.
            </li>
            <li>
              Flag detected AI patterns for a human security review step, not automatic rejection.
            </li>
            <li>
              Log which model generated which commit (Decoder surfaces this in the review metadata).
            </li>
            <li>
              Treat AI output the same way you treat third-party dependencies: verify, don't blindly
              trust.
            </li>
          </ul>
        </Section>
