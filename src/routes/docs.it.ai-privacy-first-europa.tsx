...
const FAQ = [
  {
    q: "Cosa significa davvero 'AI privacy-first'?",
    a: "Tre cose: i dati non escono dal perimetro senza decisione esplicita, tu controlli le chiavi, lo strumento è auditabile. BYOK + open source + (opzionale) inferenza locale coprono tutto.",
  },
  {
    q: "Esistono alternative europee serie a OpenAI e Anthropic?",
    a: "Sì. Mistral (Francia) per modelli open-weight e hosted. Aleph Alpha (Germania) per deployment sovrani. Silo AI (Finlandia, AMD) per LLM europei. OpenEuroLLM è l'iniziativa multilingue UE.",
  },
  {
    q: "Hostare un LLM nell'UE basta per essere GDPR-compliant?",
    a: "Necessario ma non sufficiente. Servono anche base giuridica, DPA col provider, trasparenza verso gli interessati e meccanismo di cancellazione.",
  },
  {
    q: "Decoder mi lega a un provider?",
    a: "No. BYOK su OpenAI, Anthropic, Google e OpenRouter, e supporto a Ollama / LM Studio locale. Puoi instradare su Mistral via OpenRouter oggi e cambiare quando vuoi.",
  },
];
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: DESC },
      {
        name: "keywords",
        content:
          "ai privacy first europa, ai sovrana, mistral aleph alpha, byok ai europa, gdpr ai tool, ai italia",
      },
    ...
    links: [
      ...
      { rel: "alternate", hrefLang: "en", href: EN_URL },
      {
        rel: "alternate",
        hrefLang: "zh",
        href: "https://decoderead.dev/docs/zh/privacy-first-ai-europe",
      },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 md:py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          I team europei convergono su un playbook condiviso: <strong>BYOK</strong>,{" "}
          <strong>open source</strong> e, per dati sensibili, <strong>inferenza locale</strong>.
          Questa guida spiega perché, nomina i player europei da conoscere nel 2026 e propone una
          checklist di procurement.
        </p>

        <Section
          icon={<ShieldCheck className="h-5 w-5" />}
          title="Cosa significa 'privacy-first' nella pratica"
        >
          <ul>
            <li>
              Il rapporto col provider del modello sotto il <strong>tuo</strong> contratto (BYOK).
            </li>
            <li>
              Prompt e regole del tool <strong>auditabili</strong> (open source).
            </li>
            <li>
              Possibilità di girare <strong>offline</strong> end-to-end (Ollama / LM Studio).
            </li>
            <li>
              Storage minimizzato e <strong>cifrato a riposo</strong> (AES-256-GCM per le
              credenziali).
            </li>
            <li>
              Il vendor non fa training sui tuoi dati — scritto nel contratto, non solo nel blog.
            </li>
          </ul>
        </Section>
        <Section icon={<Flag className="h-5 w-5" />} title="L'ecosistema AI europeo da conoscere">
          <ul>
            <li>
              <strong>Mistral</strong> (Parigi) — modelli open-weight e hosted, endpoint UE,
              raggiungibile via OpenRouter.
            </li>
            <li>
              <strong>Aleph Alpha</strong> (Heidelberg) — deployment sovrani per PA e industria
              regolata.
            </li>
            <li>
              <strong>Silo AI / AMD</strong> (Helsinki) — famiglie Poro e Viking, focus lingue
              europee.
            </li>
            <li>
              <strong>OpenEuroLLM</strong> — consorzio UE per LLM multilingue open.
            </li>
            <li>
              <strong>LightOn</strong> (Francia) — RAG enterprise e on-premise.
            </li>
            <li>
              <strong>Hugging Face</strong> — hub modelli/dataset, Inference Endpoints hostati in
              UE.
            </li>
          </ul>
            ...
            <table className="w-full text-sm">
              <thead className="bg-muted/40 text-foreground">
                <tr>
                  ...
                  <th className="px-3 py-2 text-left font-medium">SaaS AI tipica</th>
                  <th className="px-3 py-2 text-left font-medium">Decoder (BYOK)</th>
                  <th className="px-3 py-2 text-left font-medium">Decoder (locale)</th>
                </tr>
              </thead>
              <tbody className="text-muted-foreground [&_td]:px-3 [&_td]:py-2 [&_tr]:border-t [&_tr]:border-border">
                <tr>
                  <td className="text-foreground">Chi detiene la chiave</td>
                  <td>Vendor</td>
                  <td>Tu</td>
                  <td>N/A</td>
                </tr>
                <tr>
                  <td className="text-foreground">Dove gira l'inferenza</td>
                  <td>Cloud vendor</td>
                  <td>Provider scelto da te</td>
                  <td>La tua macchina</td>
                </tr>
                <tr>
                  <td className="text-foreground">Sub-processor</td>
                  <td>Molti</td>
                  <td>Uno (Decoder)</td>
                  <td>Zero</td>
                </tr>
                <tr>
                  <td className="text-foreground">Training sui tuoi dati</td>
                  <td>Dipende dal piano</td>
                  <td>No</td>
                  <td>No</td>
                </tr>
                <tr>
                  <td className="text-foreground">Codice disponibile</td>
                  <td>Raramente</td>
                  <td>MIT</td>
                  <td>MIT</td>
                </tr>
        ...
        <Section icon={<BookOpen className="h-5 w-5" />} title="Guide correlate">
          <ul>
            ...
            <li>
              <Link to="/docs/it/gdpr-revisione-codice-ai" className="text-foreground underline">
