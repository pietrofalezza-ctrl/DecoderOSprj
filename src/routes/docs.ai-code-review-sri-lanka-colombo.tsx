...
export const Route = createFileRoute("/docs/ai-code-review-sri-lanka-colombo")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "ai code review sri lanka, colombo developer tools, pdpa sri lanka, byok code review, open source ai review lanka" },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 md:py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Sri Lanka's software-services industry — anchored in Colombo, with growing hubs in Kandy and Galle — delivers
          code to clients across Europe, the Middle East, Australia and North America. Decoder is a free, open-source AI
          review tool that Sri Lankan teams can add to their delivery pipeline without introducing new IP or privacy risk.
        </p>

        <Section icon={<MapPin className="h-5 w-5" />} title="Where Decoder fits the Sri Lankan stack">
          <ul>
            <li><strong>Colombo service providers</strong> — audit AI-code deliveries before hand-off to European clients (GDPR-adjacent).</li>
            <li><strong>Product startups</strong> — free static + malware scan, BYOK for AI explanations.</li>
            <li><strong>Fintech &amp; banking partners</strong> — local inference (Ollama) for zero-egress review of regulated code.</li>
            <li><strong>Universities &amp; bootcamps</strong> — teach code literacy in an AI-first curriculum.</li>
          </ul>
        </Section>

        <Section icon={<ShieldCheck className="h-5 w-5" />} title="PDPA 2022 alignment">
          <p>
            Sri Lanka's Personal Data Protection Act 2022 introduces data-minimisation and cross-border-transfer duties
            similar in spirit to the GDPR and the DPDP Act. Decoder's BYOK + local-inference options make it easier to
            keep code and any embedded personal data inside your chosen perimeter.
          </p>
        </Section>
        ...
        <Section icon={<BookOpen className="h-5 w-5" />} title="Related">
          <ul>
            ...
            <li><Link to="/docs/gdpr-ai-code-review" className="text-foreground underline">GDPR &amp; AI code review (for European clients)</Link></li>
          </ul>
        </Section>
      </main>
