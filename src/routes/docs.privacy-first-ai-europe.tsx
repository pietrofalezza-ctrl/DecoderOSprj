  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: DESC },
      {
        name: "keywords",
        content:
          "privacy first ai europe, eu ai tools, sovereign ai, mistral aleph alpha, byok ai europe, gdpr ai tools",
      },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 md:py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          European engineering teams are converging on a shared playbook: <strong>BYOK</strong>,{" "}
          <strong>open source</strong>, and when the data is sensitive,{" "}
          <strong>local inference</strong>. This guide explains why, names the European players
          worth knowing in 2026, and gives a procurement checklist you can paste into your next
          vendor questionnaire.
        </p>

        <Section
          icon={<ShieldCheck className="h-5 w-5" />}
          title="What 'privacy-first' looks like in practice"
        >
          <ul>
            <li>
              The model provider relationship lives under <strong>your</strong> contract (BYOK).
            </li>
            <li>
              The tool's prompts and rules are <strong>auditable</strong> (open source).
            </li>
            <li>
              You can run end-to-end <strong>offline</strong> when needed (Ollama / LM Studio).
            </li>
            <li>
              Storage is minimised and <strong>encrypted at rest</strong> (AES-256-GCM for
              credentials).
            </li>
            <li>
              The vendor doesn't train on your data — written in the contract, not just the blog
              post.
            </li>
          </ul>
        </Section>
        ...
        <Section icon={<Flag className="h-5 w-5" />} title="The EU AI ecosystem worth knowing">
          <ul>
            <li>
              <strong>Mistral</strong> (Paris) — open-weight and hosted models, EU-hosted endpoints,
              available through OpenRouter.
            </li>
            <li>
              <strong>Aleph Alpha</strong> (Heidelberg) — sovereign deployments for government and
              regulated industry.
            </li>
            <li>
              <strong>Silo AI / AMD</strong> (Helsinki) — Poro and Viking model families, focus on
              European languages.
            </li>
            <li>
              <strong>OpenEuroLLM</strong> — EU-funded consortium for multilingual open LLMs.
            </li>
            <li>
              <strong>LightOn</strong> (France) — enterprise RAG and on-premise.
            </li>
            <li>
              <strong>Hugging Face</strong> (Franco-American) — model and dataset hub, EU-hosted
              Inference Endpoints.
            </li>
          </ul>
          <p>
            Decoder works with all of these via BYOK through OpenRouter or a direct provider
            endpoint.
          </p>
        </Section>
          ...
          <div className="not-prose overflow-x-auto rounded-lg border border-border">
            <table className="w-full text-sm">
              ...
              <tbody className="text-muted-foreground [&_td]:px-3 [&_td]:py-2 [&_tr]:border-t [&_tr]:border-border">
                <tr>
                  <td className="text-foreground">Who holds the model key</td>
                  <td>Vendor</td>
                  <td>You</td>
                  <td>N/A</td>
                </tr>
                <tr>
                  <td className="text-foreground">Where inference runs</td>
                  <td>Vendor cloud</td>
                  <td>Provider you chose</td>
                  <td>Your machine</td>
                </tr>
                <tr>
                  <td className="text-foreground">Sub-processors to audit</td>
                  <td>Many</td>
                  <td>One (Decoder)</td>
                  <td>Zero</td>
                </tr>
                <tr>
                  <td className="text-foreground">Training on your data</td>
                  <td>Depends on plan</td>
                  <td>No</td>
                  <td>No</td>
                </tr>
                <tr>
                  <td className="text-foreground">Source available</td>
                  <td>Rarely</td>
                  <td>MIT</td>
                  <td>MIT</td>
                </tr>
