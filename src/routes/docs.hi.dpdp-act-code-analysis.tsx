    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 md:py-16" lang="hi">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          भारत का डिजिटल पर्सनल डेटा प्रोटेक्शन अधिनियम 2023 यह पुनर्परिभाषित करता है कि सॉफ्टवेयर
          टीमें व्यक्तिगत डेटा को कैसे संभालती हैं — जिसमें वह डेटा भी शामिल है जो सोर्स कोड, लॉग्स
          और टेस्ट फ़िक्सचर्स के अंदर आ जाता है।
        </p>

        <Section icon={<Scale className="h-5 w-5" />} title="कोड रिव्यू के लिए तीन DPDP सिद्धांत">
          <ul>
            <li>
              <strong>डेटा मिनिमाइज़ेशन</strong> — केवल आवश्यक प्रोसेस करें।
            </li>
            <li>
              <strong>उद्देश्य सीमा</strong> — Decoder आपके कोड पर मॉडल्स को ट्रेन नहीं करता।
            </li>
            <li>
              <strong>भंडारण सीमा</strong> — अपलोड अस्थायी हैं। इतिहास आप चुनते हैं।
            </li>
          </ul>
        </Section>
        ...
        <Section
          ...
          title="Decoder डिज़ाइन से कैसे अनुरूप है"
        >
          <ul>
        ...
        <Section icon={<BookOpen className="h-5 w-5" />} title="अक्सर पूछे जाने वाले प्रश्न">
          ...
          <p className="mt-4 text-xs">
            यह कानूनी सलाह नहीं है। औपचारिक DPIA के लिए अपने DPO से परामर्श करें।
          </p>
        </Section>
