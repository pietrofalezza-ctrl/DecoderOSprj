...
export const Route = createFileRoute("/docs/ai-code-review-outsourcing")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "audit outsourced code, vendor code review, ai generated code audit, ip hygiene, copilot detection, offshore code review, ai code review checklist" },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 md:py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Outsourcing and offshore delivery models — the backbone of the Indian and Sri Lankan tech industries — now
          routinely include AI-assisted code. Buyers need a way to trust deliverables; vendors need a way to prove their
          work. Decoder gives both sides a shared checklist.
        </p>
        ...
        <Section icon={<FileCheck className="h-5 w-5" />} title="Buyer checklist before sign-off">
          <ol>
            ...
            <li>Run the delivery through Decoder's <strong>static analysis</strong> (free, no key) for complexity, dead code, dangerous patterns.</li>
            <li>Run the <strong>malware / secret scanner</strong> to catch leaked keys, obfuscated payloads, suspicious binaries.</li>
            <li>Run the <strong>AI-origin detector</strong> on suspect files; expect some AI, be sceptical if it's everywhere.</li>
            <li>Spot-check with the <strong>chat-with-code</strong> feature: pick 3 modules, ask the vendor to explain them live.</li>
        ...
        <Section icon={<Users className="h-5 w-5" />} title="Vendor best practice">
          <ul>
            ...
            <li>Attach the analysis report to the delivery email — differentiates you from competitors.</li>
            <li>Use BYOK with your own model; no client code touches a third-party SaaS you didn't choose.</li>
        ...
        <Section icon={<BookOpen className="h-5 w-5" />} title="Related guides">
          <ul>
            ...
            <li><Link to="/docs/how-to-review-ai-code" className="text-foreground underline">How to review AI code</Link></li>
