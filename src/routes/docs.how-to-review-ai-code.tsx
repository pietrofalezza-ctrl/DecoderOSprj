    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 md:py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          AI coding assistants — Copilot, Cursor, Claude Code — can ship working code in minutes.
          They can also ship hallucinated APIs, silent security holes and dependencies you never
          approved. This guide is a practical checklist for reading, reviewing and auditing that
        ...
        <Section icon={<ShieldAlert className="h-5 w-5" />} title="1. Assume nothing is grounded">
          ...
          <ul>
            <li>
              Open every imported module and confirm it is installed and at the expected version.
            </li>
            <li>
              Look up unfamiliar API calls in the official docs — not in the model&apos;s
              suggestion.
            </li>
            <li>
              Run the code in isolation with realistic inputs, not just the happy path the model
              showed you.
            </li>
          </ul>
        </Section>
        ...
        <Section icon={<Bug className="h-5 w-5" />} title="2. Hunt for the classic AI bugs">
          ...
          <ul>
            <li>
              <strong>Hallucinated APIs.</strong> Methods, options or properties that don&apos;t
              exist.
            </li>
            <li>
              <strong>Wrong error handling.</strong> Swallowed exceptions, missing retries, async
              errors not awaited.
            </li>
            <li>
              <strong>Silent type coercion.</strong> Numbers parsed as strings, dates without
              timezones, nullable values unguarded.
            </li>
            <li>
              <strong>Off-by-one and pagination.</strong> Loops that miss the last item, queries
              without limits.
            </li>
            <li>
              <strong>Race conditions.</strong> Parallel writes without locks, optimistic UI without
              rollback.
            </li>
          </ul>
        </Section>
        ...
        <Section
          ...
          title="3. Treat security as the first review pass"
        >
          <p>
          ...
          <ul>
            ...
            <li>
              Secrets read from the client bundle or committed to the repo → move to server env.
            </li>
            <li>Authorisation checks missing on server routes and database policies.</li>
            <li>File uploads with no MIME / size validation.</li>
            <li>
              CORS set to <code>*</code> on endpoints that mutate state.
            </li>
          </ul>
        </Section>
        ...
        <Section icon={<Eye className="h-5 w-5" />} title="4. Read the diff, not the summary">
          ...
          <ul>
            ...
            <li>
              New dependencies in <code>package.json</code> / lockfile.
            </li>
        ...
        <Section
          ...
          title="5. Make the review repeatable"
        >
          <ul>
            <li>
              Run linters, type checks and tests on every AI commit — same gate as a human PR.
            </li>
            <li>
              Add regression tests around the behaviour the model changed, not just new features.
            </li>
            <li>
              Keep a small set of golden prompts and outputs so you can compare model behaviour over
              time.
            </li>
            <li>
              For multi-file changes, ask the model to explain each file in plain language and
              verify the explanation matches the code.
            </li>
          </ul>
        </Section>
        ...
        <Section icon={<BookOpen className="h-5 w-5" />} title="6. Where Decoder fits">
          <p>
            ...
            provider key (OpenAI, Anthropic, Google, OpenRouter) or run fully local with Ollama / LM
            Studio, then point it at a repo or a single file. It produces a structured explanation,
            flags suspicious patterns, and lets you ask follow-up questions in multiple languages —
            without sending your code to a third-party SaaS.
          </p>
          <p>
