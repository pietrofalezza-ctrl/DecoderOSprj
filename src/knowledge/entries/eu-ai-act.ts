...
export const euAiAct: KnowledgeEntry = {
  ...
  i18n: {
    en: {
      ...
      faq: [
        {
          q: "Is Decoder a 'high-risk' AI system?",
          a: "Decoder is a tool; classification depends on how you deploy it. Code analysis is generally not high-risk.",
        },
        {
          q: "Where is data processed?",
          a: "Static and malware scans run server-side without AI. AI features call your BYOK provider — or your local model.",
        },
      ],
      glossary: [
        ...
        {
          term: "Risk tier",
          definition: "EU AI Act category (minimal, limited, high, unacceptable).",
        },
      ],
