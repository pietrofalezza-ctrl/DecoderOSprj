...
export const localAi: KnowledgeEntry = {
  ...
  i18n: {
    en: {
      ...
      faq: [
        {
          q: "Do uploaded files stay local with Local AI?",
          a: "File bodies are not sent to any AI provider. They still live in your private server storage on Decoder for the session.",
        },
        {
          q: "Which local runtimes are supported?",
          a: "Any OpenAI-compatible endpoint — Ollama and LM Studio are the common ones.",
        },
      ],
      glossary: [
        {
          term: "Local inference",
          definition: "Running model inference on hardware you control, not on a hosted API.",
        },
      ],
