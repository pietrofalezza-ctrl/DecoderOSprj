...
export const cweMapping: KnowledgeEntry = {
  ...
  i18n: {
    en: {
      ...
      faq: [
        {
          q: "Do all findings have a CWE?",
          a: "Most static rules do. Malware heuristics may not — they describe behaviour, not weaknesses.",
        },
        {
          q: "OWASP Top 10?",
          a: "CWE IDs map cleanly to OWASP categories via MITRE's published table.",
        },
      ],
      glossary: [
        {
          term: "CWE",
          definition: "Common Weakness Enumeration — MITRE's catalog of software weaknesses.",
        },
