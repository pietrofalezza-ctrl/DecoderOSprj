    ...
    en: {
      ...
      byLevel: {
        beginner: {
          ...
          practicalExample:
            "A hardcoded admin password is flagged Critical; an unused import stays Low.",
        },
        dev: {
          whatItIs:
      ...
      faq: [
        {
          q: "Is it CVSS?",
          a: "No — it's a Decoder-internal label aligned to CVSS buckets but not a CVSS score.",
        },
        {
          q: "Can I change thresholds?",
          a: "Not yet — severity is rule-defined. Custom policies are on the roadmap.",
        },
        {
          q: "Does AI affect severity?",
          a: "AI explanations don't change severity. Only detector signals do.",
        },
      ],
      glossary: [
