...
export const lockbitCaseStudy: KnowledgeEntry = {
  ...
  i18n: {
    en: {
      ...
      faq: [
        {
          q: "Do you ship the sample?",
          a: "No. We discuss patterns and let users bring their own samples.",
        },
        {
          q: "Who contributed this?",
          a: "Community contribution highlighted in the project changelog.",
        },
      ],
      glossary: [
        {
        ...
        {
          term: "Shadow copy",
          definition: "Windows backup feature commonly deleted by ransomware.",
        },
      ],
