  ...
  i18n: {
    en: {
      ...
      byLevel: {
        beginner: {
          whatItIs:
            "A number that says how mixed-up the bytes in a file look. Normal text is low; encrypted data is high.",
          whyUseful: "Helps spot files that try to hide what's inside.",
          howDecoderImplements:
            "Decoder computes entropy per section of a binary and flags anything above the suspicious threshold.",
          whenToUse: "Any time you analyse an unknown binary.",
          whenNotToUse:
            "On plain text files — entropy is naturally lower and the metric is less useful.",
          practicalExample:
            "An EXE with a `.text` section showing entropy 7.8: very likely packed.",
        },
        dev: {
          whatItIs:
      ...
      faq: [
        {
          q: "What entropy value is suspicious?",
          a: "Above ~7.0 is worth a look; above 7.5 on an executable section is a strong packing/encryption signal.",
        },
        {
          q: "Is high entropy enough to call something malware?",
          a: "No. Many benign installers and compressed files are high-entropy. Combine with structural and behavioural signals.",
        },
      ],
      glossary: [
        {
          term: "Shannon entropy",
          definition: "Information-theoretic measure of uncertainty in a distribution.",
        },
        {
          term: "Packing",
          definition:
