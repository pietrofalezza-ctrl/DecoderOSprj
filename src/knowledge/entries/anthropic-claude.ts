  ...
  i18n: {
    en: {
      ...
      faq: [
        {
          q: "Which models?",
          a: "Whichever your account has access to (Sonnet, Opus, Haiku families).",
        },
        {
          q: "Does Decoder see my key?",
          a: "Only inside the server function that issues the call. Plaintext never reaches the browser.",
        },
      ],
      glossary: [
