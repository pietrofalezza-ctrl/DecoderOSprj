    ...
    en: {
      ...
      byLevel: {
        dev: {
          ...
          howDecoderImplements: "Set the local endpoint in Settings; Decoder routes AI calls to LM Studio.",
          ...
          practicalExample: "Run Qwen2.5-Coder in LM Studio; Decoder's Explain uses it without ever calling the cloud.",
        },
      },
      faq: [
        { q: "Ollama or LM Studio?", a: "Both work. LM Studio has a richer GUI; Ollama is CLI-first." },
        { q: "Does Decoder ship a model?", a: "No — install and pick one in LM Studio." },
      ],
      glossary: [
        { term: "OpenAI-compatible", definition: "An HTTP API mirroring OpenAI's chat/completions shape." },
      ],
