...
> = {
  "static-malware-analysis": {
    it: {
      ...
      byLevel: {
        beginner: {
          whatItIs:
            "Decoder legge il codice come testo e segnala cose pericolose, senza eseguirle.",
          whyUseful: "Trovi problemi prima che il codice venga lanciato, gratis e senza chiavi AI.",
          howDecoderImplements:
            "Pattern, regole YARA, controllo entropia e rilevamento segreti girano in locale sul server.",
          whenToUse: "Sempre come primo passo prima di eseguire o pubblicare uno script.",
          whenNotToUse:
            "Quando serve capire l'intento profondo del codice: lì entra l'AI (opzionale).",
          practicalExample:
            "Carichi un .ps1, Decoder evidenzia comandi DownloadString e stringhe Base64 sospette.",
        },
        dev: {
          whatItIs:
            "Pipeline statica multi-linguaggio che combina regole, YARA, entropia e secret scanning sul source.",
          whyUseful: "Feedback deterministico, riproducibile, senza inviare il codice a un LLM.",
          howDecoderImplements:
            "Parser per linguaggio, regole versionate, scoring CWE-aware, output strutturato per UI e API.",
          whenToUse: "Come baseline di sicurezza in ogni triage o code review.",
          whenNotToUse:
            "Quando il valore è la spiegazione semantica: combina con la modalità AI Explain.",
          practicalExample:
            "Su un repo Node, Decoder trova require dinamici, scripts npm sospetti e token in chiaro in .env.",
        },
      },
      faq: [
        {
          q: "Serve una chiave AI?",
          a: "No. L'analisi statica e malware è gratuita e non chiama nessun provider esterno.",
        },
        {
          q: "Quali file supporta?",
          a: "Python, JavaScript/TypeScript, Java, Go, Rust, PowerShell, ZIP, Dockerfile e oltre 20 formati.",
        },
        {
          q: "I miei file vengono salvati?",
          a: "Solo per la sessione corrente: niente training, niente condivisione.",
        },
      ],
      glossary: [
        {
          term: "Entropia",
          definition:
            "Misura della casualità di una stringa — alta entropia segnala spesso payload offuscati o segreti.",
        },
        {
          term: "YARA",
          definition:
            "Linguaggio di regole per descrivere e cercare pattern di malware nel codice o nei binari.",
        },
      ],
    ...
    zh: {
      ...
      metaDescription: "对源代码进行静态与恶意软件扫描:模式匹配、熵分析、密钥检测,无需 AI 密钥。",
      intro:
      ...
      faq: [
        ...
        {
          q: "支持哪些文件?",
          a: "Python、JavaScript/TypeScript、Java、Go、Rust、PowerShell、ZIP、Dockerfile 等 20+ 格式。",
        },
      ],
      glossary: [
  ...
  byok: {
    it: {
      ...
      byLevel: {
        beginner: {
          whatItIs:
            "Colleghi il tuo account AI personale a Decoder invece di usarne uno condiviso.",
          whyUseful:
            "Uso tuo, fatturazione tua, privacy tua: nessun altro vede o paga al posto tuo.",
          howDecoderImplements:
            "Incolli la chiave in Impostazioni, viene cifrata e usata solo per le tue richieste.",
          ...
          practicalExample:
            "Aggiungi una chiave OpenRouter, clicchi Spiega su una funzione: Decoder chiama come te.",
        },
        dev: {
          whatItIs:
            "Pattern in cui l'app accetta credenziali del provider portate dall'utente invece di un account backend condiviso.",
          whyUseful:
            "Elimina il trust condiviso, semplifica compliance, isola i rate-limit per utente.",
          howDecoderImplements:
            "Chiavi cifrate AES-256-GCM, decifrate solo lato server-function, mai restituite al client.",
          ...
          practicalExample:
            "Settings → aggiungi chiave → ciphertext in user_ai_credentials; revoca = invalidazione immediata.",
        },
      },
      faq: [
        {
          q: "Dove viene salvata la mia chiave?",
          a: "Cifrata AES-256-GCM nel database, accessibile solo al tuo utente tramite RLS.",
        },
        {
          q: "Gli admin di Decoder possono leggerla?",
          a: "No: la decifratura avviene solo dentro la server function che chiama il provider.",
        },
        {
          q: "Quali provider sono supportati?",
          a: "OpenAI, Anthropic, Gemini, OpenRouter. In alternativa puoi usare modelli locali (Ollama, LM Studio).",
        },
      ],
      glossary: [
        {
          term: "BYOK",
          definition: "Bring Your Own Key — l'utente fornisce le proprie credenziali del provider.",
        },
        {
          term: "RLS",
          definition:
            "Row-Level Security — policy a livello DB che isola le righe per utente autenticato.",
        },
      ],
    ...
    zh: {
      ...
      intro: "BYOK 意味着自带 AI 密钥:不走共享账户,你自己的账单,你自己的隐私边界。",
      byLevel: {
        beginner: {
      ...
      faq: [
        ...
        {
          q: "支持哪些提供商?",
          a: "OpenAI、Anthropic、Gemini、OpenRouter;也可使用本地模型(Ollama、LM Studio)。",
        },
      ],
  ...
  "repository-analysis": {
    it: {
      ...
      byLevel: {
        beginner: {
          whatItIs:
            "Dai a Decoder un intero progetto e lui ti dice cosa contiene e dove sono i problemi.",
          whyUseful: "Visione d'insieme prima di leggere file per file.",
          howDecoderImplements:
            "Estrae lo ZIP, indicizza i file, lancia analisi statica/malware e abilita la chat sul progetto.",
          ...
          practicalExample:
            "Incolli un URL GitHub: in pochi secondi vedi linguaggi, file sospetti e una chat pronta a rispondere.",
        },
      },
      faq: [
        {
          q: "Posso analizzare repo privati?",
          a: "Sì, caricando lo ZIP esportato. L'integrazione GitHub OAuth è in roadmap.",
        },
        {
          q: "C'è un limite di dimensione?",
          a: "Sì, per proteggere il server: ZIP molto grandi vengono rifiutati con un messaggio chiaro.",
        },
      ],
      glossary: [
        { term: "ZIP", definition: "Archivio standard usato per impacchettare un repository." },
      ],
  ...
  "local-ai": {
    it: {
      ...
      byLevel: {
        beginner: {
          whatItIs:
            "Un modello AI installato sul tuo computer che Decoder può chiamare al posto di OpenAI o simili.",
          whyUseful: "Il codice non lascia mai la tua macchina.",
          howDecoderImplements:
            "Decoder rileva Ollama/LM Studio in ascolto su localhost e lo offre come provider AI.",
          ...
          practicalExample:
            "Avvii Ollama con llama3, in Decoder selezioni 'Local AI' e ottieni spiegazioni senza BYOK cloud.",
        },
      },
      faq: [
        {
          q: "Servono GPU?",
          a: "Aiutano molto, ma piccoli modelli quantizzati girano anche solo su CPU.",
        },
      ],
      glossary: [
        {
          term: "Inferenza",
          definition: "Esecuzione di un modello AI per produrre output da un input.",
        },
      ],
    ...
    zh: {
      ...
      byLevel: {
        beginner: {
          ...
          howDecoderImplements:
            "Decoder 检测 localhost 上的 Ollama/LM Studio 并将其作为 AI 提供商。",
  ...
  ollama: {
    it: {
      ...
      metaDescription:
        "Decoder si collega a Ollama in localhost per chiamare modelli AI locali in modo privato.",
      intro:
        "Ollama è il runtime più comodo per servire modelli AI locali via HTTP. Decoder lo usa come provider.",
      byLevel: {
        beginner: {
          whatItIs:
            "Un programma che fa girare modelli AI sul tuo computer e li espone come una piccola API.",
          whyUseful:
            "Una volta installato, qualsiasi app — Decoder incluso — può chiedergli una spiegazione senza internet.",
          howDecoderImplements:
            "Decoder chiama http://localhost:11434, elenca i tuoi modelli e li usa come provider AI.",
          ...
          practicalExample:
            "ollama pull llama3, riapri Decoder: il modello compare tra i provider disponibili.",
        },
      },
      faq: [
        {
          q: "Devo aprire porte sulla rete?",
          a: "No, Decoder parla con Ollama via localhost dalla tua macchina.",
        },
      ],
      glossary: [
        { term: "Localhost", definition: "Indirizzo di rete che punta alla tua stessa macchina." },
      ],
    ...
    zh: {
      ...
      byLevel: {
        beginner: {
          ...
          howDecoderImplements:
            "Decoder 调用 http://localhost:11434,列出你的模型并作为 AI 提供商使用。",
      ...
      faq: [
        { q: "需要开放网络端口吗?", a: "不需要,Decoder 只通过本机 localhost 与 Ollama 通讯。" },
      ],
  ...
  "chat-with-code": {
    it: {
      ...
      intro:
        "La chat sul codice ti permette di interrogare un file o un repo intero come se parlassi con un collega.",
      byLevel: {
        beginner: {
          ...
          howDecoderImplements:
            "Decoder costruisce un contesto dal tuo upload e lo passa al provider AI scelto (BYOK o locale).",
          ...
          practicalExample:
            "Chiedi 'cosa fa questo script?' e Decoder risponde citando le righe rilevanti.",
        },
      },
      faq: [
        {
          q: "Serve una chiave?",
          a: "Sì, oppure un modello locale. La chat usa un LLM, non regole statiche.",
        },
        {
          q: "Le conversazioni vengono salvate?",
          a: "Solo nel tuo account, e le puoi ripescare dallo storico.",
        },
      ],
      glossary: [
        {
          term: "Contesto",
          definition: "Insieme di file e snippet passati all'LLM per rispondere alla domanda.",
        },
      ],
    ...
    zh: {
      ...
      metaDescription: "用自然语言提问你上传的代码,答案锚定到文件,语气与深度由你选择。",
      ...
      byLevel: {
        beginner: {
          ...
          howDecoderImplements:
            "Decoder 从上传内容构建上下文,交给你选择的 AI 提供商(BYOK 或本地)。",
  ...
  "ai-origin-detection": {
    it: {
      ...
      byLevel: {
        beginner: {
          whatItIs:
            "Un controllo che dice quanto è probabile che il codice arrivi da un AI generativo.",
          whyUseful: "Utile in code review, didattica o triage di codice sospetto.",
          howDecoderImplements:
            "Modello statistico locale + verbalizzazione AI opzionale (BYOK) per spiegare i segnali.",
          ...
          practicalExample:
            "Incolli una funzione, Decoder restituisce uno score 0–100 e i segnali principali.",
        },
      },
      faq: [
        {
          q: "È preciso?",
          a: "Indicativo: gli LLM moderni imitano gli umani molto bene. Usa il risultato come uno dei segnali, non come verità.",
        },
      ],
      glossary: [
        {
          term: "LLM",
          definition: "Large Language Model — modello AI generativo di testo o codice.",
        },
      ],
  ...
  "zip-analysis": {
    it: {
      ...
      intro:
        "Lo ZIP è il modo più semplice di passare un progetto a Decoder, anche per file singoli (vengono impacchettati lato client).",
      byLevel: {
        beginner: {
          whatItIs:
            "Decoder apre il tuo archivio e tratta ogni file come se l'avessi caricato uno a uno.",
          whyUseful: "Un solo upload per un intero progetto.",
          howDecoderImplements:
            "Estrazione in sandbox con controlli anti zip-slip e tetto massimo di dimensione.",
          whenToUse: "Sempre, per repo o cartelle di più file.",
          whenNotToUse: "Per file singoli puoi anche fare drag-and-drop diretto.",
          practicalExample:
            "Carichi project.zip da 5 MB, Decoder lo apre e mostra l'albero dei file analizzati.",
        },
      },
      faq: [
        {
          q: "C'è un limite di dimensione?",
          a: "Sì, per protezione: archivi troppo grandi vengono rifiutati con un messaggio chiaro.",
        },
      ],
      glossary: [
        {
          term: "Zip-slip",
          definition: "Attacco in cui un archivio scrive file fuori dalla cartella di estrazione.",
        },
      ],
  ...
  sast: {
    it: {
      ...
      intro:
        "SAST è la disciplina di trovare vulnerabilità leggendo il codice. Decoder offre uno SAST leggero, esplicabile e gratuito.",
      byLevel: {
        dev: {
          whatItIs:
            "Insieme di regole e analisi che leggono il sorgente per individuare pattern insicuri.",
          whyUseful: "Trovi problemi prima del deploy, senza dover eseguire l'applicazione.",
          howDecoderImplements:
            "Pattern multi-linguaggio, mapping CWE, scoring di severità, output ricco di contesto.",
          ...
          practicalExample:
            "Decoder segnala una SQL injection in un endpoint Express con riga, CWE e suggerimento.",
        },
      },
      faq: [
        {
          q: "Sostituisce un SAST enterprise?",
          a: "Copre il caso quotidiano: per stack enterprise complessi resta utile uno strumento dedicato.",
        },
      ],
      glossary: [
        {
          term: "CWE",
          definition: "Common Weakness Enumeration — tassonomia standard di debolezze software.",
        },
      ],
  ...
  "secret-detection": {
    it: {
      ...
      metaDescription:
        "Trova chiavi API, token e credenziali finiti per errore nel codice sorgente.",
      intro:
        "Decoder cerca pattern noti e stringhe ad alta entropia che assomigliano a chiavi o token.",
      byLevel: {
        dev: {
          whatItIs:
            "Scansione che combina regex su prefissi noti (AKIA, ghp_, sk-...) e analisi entropica.",
          whyUseful:
            "Segreti committati per errore sono una delle cause principali di data breach.",
          howDecoderImplements:
            "Regole versionate + euristiche su entropia, con dedup e contesto della riga.",
          ...
          practicalExample:
            "Carichi un repo, Decoder evidenzia un AKIA hardcoded in scripts/deploy.sh.",
        },
      },
      faq: [
        {
          q: "Cosa faccio se trovo un segreto?",
          a: "Revoca subito, ruota la chiave e riscrivi la storia git.",
        },
      ],
      glossary: [
        {
          term: "Entropia",
          definition: "Misura di casualità — segreti reali hanno entropia alta.",
        },
      ],
  ...
  "cwe-mapping": {
    it: {
      ...
      intro:
        "Il CWE è la lingua comune della sicurezza del software: Decoder lo usa per rendere ogni finding confrontabile.",
      byLevel: {
        dev: {
          ...
          howDecoderImplements:
            "Ogni regola statica espone il CWE corrispondente; la UI lo mostra accanto al titolo.",
          ...
          practicalExample:
            "Decoder segnala 'Hardcoded credential — CWE-798' e linka al riferimento ufficiale.",
        },
      },
      faq: [
        {
          q: "Quali CWE coprite?",
          a: "Le top-25 più diffuse e altre rilevanti per i linguaggi supportati.",
        },
      ],
      glossary: [
        {
          term: "CWE",
          definition: "Common Weakness Enumeration — tassonomia delle debolezze software.",
        },
      ],
  ...
  "supply-chain-security": {
    it: {
      ...
      byLevel: {
        dev: {
          whatItIs:
            "Insieme di controlli sulle dipendenze del tuo progetto (package.json, requirements.txt, ecc.).",
          whyUseful: "Una sola dipendenza compromessa basta a bucare tutto.",
          howDecoderImplements:
            "Parsing dei manifest, segnali su install script, typosquatting e versioni note vulnerabili.",
          ...
          practicalExample:
            "Decoder evidenzia un package npm con install script che scarica un binario remoto.",
        },
      },
      faq: [
        {
          q: "Generate uno SBOM?",
          a: "Non oggi: ci concentriamo sui segnali a rischio immediato.",
        },
      ],
      glossary: [
        {
          term: "Typosquatting",
          definition: "Pacchetti con nomi simili a librerie famose, pubblicati per ingannare.",
        },
  ...
  "eu-ai-act": {
    it: {
      ...
      byLevel: {
        senior: {
          whatItIs:
            "Regolamento europeo che classifica i sistemi AI per livello di rischio e impone obblighi corrispondenti.",
          whyUseful:
            "Definisce chiaramente cosa serve fare per usare AI in modo conforme dentro l'UE.",
          howDecoderImplements:
            "Decoder non addestra modelli, non profila utenti, supporta inferenza locale e BYOK: configurabile per restare a basso rischio.",
          whenToUse: "Quando il tuo team valuta strumenti AI per code review in contesto regolato.",
          whenNotToUse:
            "Come consulenza legale: questa pagina è informativa, non sostituisce un avvocato.",
          practicalExample:
            "Una banca italiana adotta Decoder in modalità BYOK + audit trail per restare in fascia basso/limitato.",
        },
      },
      faq: [
        {
          q: "Decoder è high-risk?",
          a: "No, è pensato per restare in fascia limited/minimal. Vedi /docs/eu-ai-act-code-analysis per il dettaglio.",
        },
      ],
      glossary: [
        {
          term: "High-risk",
          definition:
            "Categoria AI Act con obblighi stringenti (gestione rischi, log, supervisione).",
        },
      ],
    ...
    zh: {
      ...
      intro:
        "欧盟 AI 法案按风险等级对 AI 系统设义务。Decoder 设计为低风险:不训练你的数据、支持 BYOK 与本地推理。",
      byLevel: {
        senior: {
  ...
  "gdpr-compliance": {
    it: {
      ...
      byLevel: {
        senior: {
          whatItIs:
            "Regolamento UE su dati personali: principi di minimizzazione, liceità, sicurezza, accountability.",
          whyUseful: "Definisce cosa puoi inviare a un servizio terzo e come deve trattarlo.",
          howDecoderImplements:
            "Upload non persistiti oltre la sessione, BYOK cifrato, nessun training, ruoli admin tracciati.",
          ...
          practicalExample:
            "Un'azienda tedesca usa Decoder con chiave OpenAI EU residency e tiene gli upload in cartelle scope-limited.",
        },
      },
      faq: [
        {
          q: "Dove vivono i dati?",
          a: "Sul backend Decoder (EU) per la sessione; le chiamate AI vanno al provider scelto via BYOK.",
        },
      ],
      glossary: [
        {
          term: "PII",
          definition: "Personally Identifiable Information — dati che identificano una persona.",
        },
      ],
    ...
    zh: {
      ...
      intro:
        "代码本身通常不是个人数据,但可能含有。Decoder 把上传视为敏感数据,BYOK 隔离,日志最小化。",
      byLevel: {
        senior: {
      ...
      faq: [
        {
          q: "数据存放在哪里?",
          a: "会话期间存于 Decoder 欧盟后端;AI 调用按 BYOK 走你选的提供商。",
        },
      ],
  ...
  "obfuscation-detection": {
    it: {
      ...
      intro:
        "L'offuscamento è il modo più comune per nascondere malware nel codice apparentemente legittimo.",
      byLevel: {
        dev: {
          whatItIs:
            "Analisi che combina entropia, lunghezza media degli identificatori, presenza di eval/Function() e Base64 decode.",
          whyUseful: "Codice offuscato in librerie open source è quasi sempre un red flag.",
          howDecoderImplements:
            "Score di offuscamento per file con breakdown dei segnali contribuenti.",
          whenToUse:
            "Su tutto ciò che proviene da fonti non verificate (pastebin, fork sconosciuti).",
          whenNotToUse: "Su bundle minificati legittimi: l'output può sembrare offuscato.",
          practicalExample:
            "Decoder marca uno script npm post-install con score 0.92 e segnala eval(atob(...)).",
        },
      },
      faq: [
        {
          q: "Minificato = offuscato?",
          a: "No, ma alcuni segnali si sovrappongono: leggi sempre il contesto.",
        },
      ],
      glossary: [
        {
          term: "Eval",
          definition:
            "Funzione che esegue stringhe come codice — rischiosa se la stringa è dinamica.",
        },
      ],
  ...
  "lockbit-case-study": {
    it: {
      ...
      byLevel: {
        security: {
          whatItIs:
            "Analisi statica + AI di un loader LockBit 3.0 reso pubblico in incident report.",
          whyUseful:
            "Mostra come unire pattern deterministici e spiegazione AI per accorciare il triage.",
          howDecoderImplements:
            "Analisi statica → mapping CWE → verbalizzazione AI con BYOK del team.",
          ...
          practicalExample:
            "Decoder evidenzia il loader, segnala API Windows sospette e produce un riassunto leggibile in 30 secondi.",
        },
      },
      faq: [
        {
          q: "Il codice è disponibile?",
          a: "No, riportiamo solo segnali e tecniche pubblicamente discusse.",
        },
      ],
      glossary: [
        {
          term: "Loader",
          definition: "Stadio iniziale di un malware che scarica o decifra il payload reale.",
        },
      ],
    ...
    zh: {
      ...
      metaDescription: "Decoder 如何分析 LockBit 3.0 loader:静态模式、恶意信号、AI 解读。",
      intro:
        "LockBit 3.0 是高影响勒索软件家族。本案例展示 Decoder 如何拆解一个公开 loader 并发现了什么。",
      byLevel: {
        security: {
